...
export default function ResultCard({ explanation, extracted, barcode, confidence }: Props) {
  ...
  const gl = Array.isArray(explanation?.label_vs_guidelines) ? explanation.label_vs_guidelines : [];
  ...
  return (
    <div className="card">
<div style={{marginTop:8}}><ProductLink brand={brandStr} product={productName} ingredient={retailFirstIngredient} amount={retailAmount} unit={retailUnit} /></div>
